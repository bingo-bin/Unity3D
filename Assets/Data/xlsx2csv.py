...
class Xlsx2csv:
    ...
    def __init__(self, xlsxfile, **options):
        ...
        options.setdefault("skip_empty_lines", True)
            ...
            if self.colType == "s": # shared string
                ...
                if format_type:
                    try:
                        ...
                        elif format_type=='float' and ('0' in format_str ):
                            print self.data
                            t=int(round(float(self.data)))
                            self.data="%i" %t
						...
						#elif format_type == 'float' and format_str[0:3] == '0.1':
                        #    L = len(format_str.split(".")[1])
                        #    if '%' in format_str:
                        #        L += 1
                        #    self.data = ("%." + str(L) + "f") % float(self.data)	
							...
							#print format_type
						    #self.data=self.data
							#self.data="%d" %int(round(self.data))
