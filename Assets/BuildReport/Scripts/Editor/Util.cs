...
public static class Util
{
	...
	public static string RemoveSuffix(string suffix, string val, int offset)
	{
	...
	{
		string projectFolder = RemoveSuffix("Assets", Application.dataPath,0);
	...
	public static BuildInfo OpenSerializedBuildInfo(string serializedBuildInfoFilePath, bool fromMainThread)
	{
		BuildInfo ret = null;
